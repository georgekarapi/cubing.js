import{a as L}from"./chunk-4NIKTWAF.js";import{c as R,h as B,o as D}from"./chunk-D3X4C52T.js";import"./chunk-ULM6IQGD.js";import"./chunk-OUWZ2PU5.js";var r=null;async function n(){return r??(r=o())}async function o(){return L(await B.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg u
Alg u'`)}async function d(){let{getPuzzleGeometryByName:g,ExperimentalPGNotation:A}=await import("./puzzle-geometry-NAEPGQRU.js"),l=g("skewb",{allMoves:!0,addRotations:!0});return new R(l.getKPuzzleDefinition(!0),{experimentalPGNotation:new A(l,l.getOrbitsDef(!0))})}var p=null;async function a(){return p??(p=d())}var P=null;async function t(){return P??(P=h())}async function x(){return{ordering:(await t()).ordering.slice(1)}}async function h(){return L(await a(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
//# sourceMappingURL=search-dynamic-sgs-side-events-QU6MRY6Z.js.map
