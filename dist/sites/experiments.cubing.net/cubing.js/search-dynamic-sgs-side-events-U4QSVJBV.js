import{a as L}from"./chunk-EVMKWAS7.js";import{c as B,e as D}from"./chunk-S4ZNJEAB.js";import{b as R}from"./chunk-CM3DPZVF.js";import"./chunk-QIOL4UIE.js";import"./chunk-K5RKCHW3.js";import"./chunk-SYRP7SJ5.js";var r=null;async function n(){return r??(r=o())}async function o(){return L(await B.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg F D F' D L2 F R' F' D' B2 U'`)}async function i(){let{getPuzzleGeometryByName:g,ExperimentalPGNotation:A}=await import("./puzzle-geometry-OIWNBVFY.js"),l=g("megaminx",{allMoves:!0,addRotations:!0}),F=new R(l.getKPuzzleDefinition(!0),{experimentalPGNotation:new A(l,l.getOrbitsDef(!0))});return F.definition.name="megaminx",F}var u=null;async function U(){return u??(u=i())}var c=null;async function s(){return c??(c=m())}async function m(){return L(await U(),`SubgroupSizes 12 5 60 58 60 56 54 57 52 50 54 48 46 51 44 42 48 40 45 38 36 42 34 32 39 30 36 28 26 33 24 30 22 20 27 18 24 16 14 21 12 18 10 15 8 6 2 12 9 3
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var S=null;async function e(){return S??(S=z())}async function y(){return{ordering:(await e()).ordering.slice(2)}}async function z(){return L(await D.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function d(){let{getPuzzleGeometryByName:g,ExperimentalPGNotation:A}=await import("./puzzle-geometry-OIWNBVFY.js"),l=g("skewb",{allMoves:!0,addRotations:!0});return new R(l.getKPuzzleDefinition(!0),{experimentalPGNotation:new A(l,l.getOrbitsDef(!0))})}var p=null;async function a(){return p??(p=d())}var P=null;async function t(){return P??(P=h())}async function x(){return{ordering:(await t()).ordering.slice(1)}}async function h(){return L(await a(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{n as cachedData222,U as cachedMegaminxKPuzzleWithoutMO,s as cachedSGSDataMegaminx,e as sgsDataPyraminx,y as sgsDataPyraminxFixedOrientation,t as sgsDataSkewb,x as sgsDataSkewbFixedCorner,a as skewbKPuzzleWithoutMOCached};
//# sourceMappingURL=search-dynamic-sgs-side-events-U4QSVJBV.js.map
